      ...
      >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6 w-full" style={{ gridAutoRows: "1fr" }}>
          ...
          <Reveal delay={0.1} style={{ height: "100%" }}>
            <StatCard value={10} suffix="M+" label="Spravovaných budgetů" sublabel="ročně v aktivně řízených kampaních" icon={Banknote} accent="#818cf8" delay={0.1} numberSize="3.5rem" />
          </Reveal>
